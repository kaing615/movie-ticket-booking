...
const RevenueDashboard1 = () => {
  ...
  }, [dateRange, viewType, selectedMovieId, selectedRoomId]);
            ...
            <Row gutter={[12, 12]} align="middle">
              <Col flex="auto">
                <Space size={10} wrap>
                  ...
                  />
                  {/* Movie filter */}
                  <Tooltip title="Lọc theo phim">
                    <select
                      value={selectedMovieId}
                      onChange={e => setSelectedMovieId(e.target.value)}
                      style={{ minWidth: 160, height: 36, borderRadius: 8, border: "1px solid #d9d9d9" }}
                    >
                      <option value="">Tất cả phim</option>
                      {allMovies.map(m => (
                        <option key={m.movieId || m._id} value={m.movieId || m._id}>
                          {m.movieName}
                        </option>
                      ))}
                    </select>
                  ...
                  {/* Room filter */}
                  <Tooltip title="Lọc theo phòng">
                    <select
                      value={selectedRoomId}
                      onChange={e => setSelectedRoomId(e.target.value)}
                      style={{ minWidth: 120, height: 36, borderRadius: 8, border: "1px solid #d9d9d9" }}
                    >
...
export default RevenueDashboard1;