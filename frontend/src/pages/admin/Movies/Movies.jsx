        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Form.Item
              ...
              label="Producer"
              rules={[
                { required: true, message: "Please enter producer name!" },
              ]}
            >
            ...
            <Form.Item
              ...
              label="Actors"
              rules={[
                { required: true, message: "Please add at least one actor!" },
              ]}
            >
              <Select
                mode="tags"
                placeholder="Type and press Enter to add actors"
            ...
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please select allowed show start date!",
                },
              ]}
            >
              <DatePicker format="YYYY-MM-DD" className="w-full rounded-md" />
            ...
            <Form.Item
              ...
              label="Movie Rating"
              rules={[
                { required: true, message: "Please select movie rating!" },
              ]}
            >
