                        ...
                        <div className="overflow-x-auto pb-2 mb-6">
                            <div className="flex gap-2 min-w-max">
                                {uniqueDates.map((date, idx) => (
                                    <button
                                        key={idx}
                                        className={`flex flex-col items-center text-center text-xs sm:text-sm min-w-[70px] sm:min-w-[80px] h-16 rounded-lg py-2 cursor-pointer transition-all duration-200 ${date === selectedDate
