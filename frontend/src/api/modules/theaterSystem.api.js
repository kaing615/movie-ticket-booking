...
export const theaterSystemApi = {
    getAllTheaterSystems: async () => {
        const res = await publicClient.get(theaterSystemEndpoints.getAllTheaterSystems);
        return res.data;
    },
    getTheaterSystemById: async (systemId) => {
        const res = await publicClient.get(theaterSystemEndpoints.getTheaterSystemById(systemId));
        return res.data;
    }
};
