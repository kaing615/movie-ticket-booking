...
const seedDatabase = async () => {
  try {
    ...
    console.log("Existing user cleared.");
    ...
    const managerPassword = await bcrypt.hash("123456", salt);
    ...
    const customerPassword1 = await bcrypt.hash("123456", salt);
    ...
    console.log("Database seeding completed successfully with diverse data!");
  } catch (error) {
